...
export const ToastItem: React.FC<ToastProps> = ({ id, type, title, message, onClose }) => {
  ...
  const borderColors = {
    ...
    info: 'border-cyan-500/40 shadow-[0_0_25px_rgba(6,182,212,0.3)]',
  };
  ...
  return (
    <motion.div
      ...
      className={`glass-card p-4 rounded-xl flex items-start gap-3 border ${borderColors[type]} max-w-md w-full pointer-events-auto`}
    >
      {icons[type]}
